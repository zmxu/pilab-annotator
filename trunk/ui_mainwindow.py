...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("graphics/click-point.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("graphics/select-rectangle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 51, 224))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("graphics/click-point-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.verticalLayout_2.addWidget(self.dotClickButton)
        self.dotDragButton = QtGui.QPushButton(self.verticalLayoutWidget_2)
        self.dotDragButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.dotDragButton.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("graphics/move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("graphics/select-rectangle-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rectClickButton.setIcon(icon4)
        ...
        self.undoButton = QtGui.QPushButton(self.verticalLayoutWidget_2)
        self.undoButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.undoButton.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("graphics/undo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.undoButton.setIcon(icon5)
        self.undoButton.setIconSize(QtCore.QSize(30, 23))
        self.undoButton.setCheckable(False)
        self.undoButton.setObjectName("undoButton")
        self.verticalLayout_2.addWidget(self.undoButton)
        self.redoButton = QtGui.QPushButton(self.verticalLayoutWidget_2)
        self.redoButton.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("graphics/redo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.redoButton.setIcon(icon6)
        self.redoButton.setIconSize(QtCore.QSize(30, 23))
        self.redoButton.setObjectName("redoButton")
        self.verticalLayout_2.addWidget(self.redoButton)
        ...
        self.pointsAction = QtGui.QAction(mainWindow)
        self.pointsAction.setCheckable(True)
        self.pointsAction.setObjectName("pointsAction")
        self.rectanglesAction = QtGui.QAction(mainWindow)
        self.rectanglesAction.setCheckable(True)
        self.rectanglesAction.setObjectName("rectanglesAction")
        ...
        self.viewMenu.addAction(self.pointsAction)
        self.viewMenu.addAction(self.rectanglesAction)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.pointsAction.setText(QtGui.QApplication.translate("mainWindow", "Points", None, QtGui.QApplication.UnicodeUTF8))
        self.pointsAction.setShortcut(QtGui.QApplication.translate("mainWindow", "P", None, QtGui.QApplication.UnicodeUTF8))
        self.rectanglesAction.setText(QtGui.QApplication.translate("mainWindow", "Rectangles", None, QtGui.QApplication.UnicodeUTF8))
        self.rectanglesAction.setShortcut(QtGui.QApplication.translate("mainWindow", "R", None, QtGui.QApplication.UnicodeUTF8))
